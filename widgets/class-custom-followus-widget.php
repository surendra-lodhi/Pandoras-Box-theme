...
add_action( 'widgets_init', 'pandorabox_followus_widget' );

/**
 * Register the Follow Us Widget
 */
function pandorabox_followus_widget() {
...
class Followus extends WP_Widget {
    ...
    function __construct(){
        parent::__construct(
                'followus', // Base ID
                __( 'Pandora Box - Follow Us', 'pandorabox' ), // Name
                array('description' => __( 'Custom follow us widget', 'pandorabox' )) // Args
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        if( pandorabox_check_acf_activation() ) {
...
<?php
    ...
    ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'pandorabox' ); ?></label> 
